...
Nothing anywhere states what _the same blueprint_ should do across CLI, HTTP,
...
_should_ apply and does not; those are findings, not exemptions.
...
so _"exactly 4 succeed"_ is a race, not a contract: a request arriving a
